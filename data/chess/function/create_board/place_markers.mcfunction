...
# Position between 1-64 wrapped between 1-8 in #pos_modulo
...
execute at @s if score #counter temp matches 0 anchored eyes positioned ^ ^ ^5 align xyz run summon marker ~ ~ ~ {Tags:["board_square","new_square"]}
