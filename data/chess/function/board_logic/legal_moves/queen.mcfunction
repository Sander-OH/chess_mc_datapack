...
# EAST
# get length
$execute store result score #len temp run data get storage chess:lookup rook_east."$(position)"
$data modify storage chess:temp positions set from storage chess:lookup rook_east."$(position)"
...
# SOUTH
# get length
$execute store result score #len temp run data get storage chess:lookup rook_south."$(position)"
$data modify storage chess:temp positions set from storage chess:lookup rook_south."$(position)"
...
# WEST
# get length
$execute store result score #len temp run data get storage chess:lookup rook_west."$(position)"
$data modify storage chess:temp positions set from storage chess:lookup rook_west."$(position)"
...
# NORTH
# get length
$execute store result score #len temp run data get storage chess:lookup rook_north."$(position)"
$data modify storage chess:temp positions set from storage chess:lookup rook_north."$(position)"
