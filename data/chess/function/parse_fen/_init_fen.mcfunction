...
#test position 2 (pawn promotion)
execute if score #fen_to_load temp matches 2 run data modify storage chess:parser fen set value "3qkbnr.P7.8.8.8.8.p7.3QKBNR"
