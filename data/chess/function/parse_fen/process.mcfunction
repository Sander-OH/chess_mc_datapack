execute if data storage chess:parser {char:"1"} run return run function chess:parse_fen/_increment_position {index:1}
execute if data storage chess:parser {char:"2"} run return run function chess:parse_fen/_increment_position {index:2}
execute if data storage chess:parser {char:"3"} run return run function chess:parse_fen/_increment_position {index:3}
execute if data storage chess:parser {char:"4"} run return run function chess:parse_fen/_increment_position {index:4}
execute if data storage chess:parser {char:"5"} run return run function chess:parse_fen/_increment_position {index:5}
execute if data storage chess:parser {char:"6"} run return run function chess:parse_fen/_increment_position {index:6}
execute if data storage chess:parser {char:"7"} run return run function chess:parse_fen/_increment_position {index:7}
execute if data storage chess:parser {char:"8"} run return run function chess:parse_fen/_increment_position {index:8}
